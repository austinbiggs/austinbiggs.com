...
export type GetPageByIdQuery = { __typename?: "query_root" } & {
  pages_by_pk?: Types.Maybe<
    { __typename?: "pages" } & Pick<
      Types.Pages,
      "id" | "createdAt" | "updatedAt" | "status" | "slug" | "title"
    > & {
 ...
 * });
 */
export function useGetPageByIdQuery(
  ...
  return Apollo.useQuery<GetPageByIdQuery, GetPageByIdQueryVariables>(
    GetPageByIdDocument,
    options
  );
}
export function useGetPageByIdLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetPageByIdQuery, GetPageByIdQueryVariables>(
    GetPageByIdDocument,
    options
  );
}
export type GetPageByIdQueryHookResult = ReturnType<typeof useGetPageByIdQuery>;
export type GetPageByIdLazyQueryHookResult = ReturnType<
  typeof useGetPageByIdLazyQuery
>;
export type GetPageByIdQueryResult = Apollo.QueryResult<
  GetPageByIdQuery,
  GetPageByIdQueryVariables
>;
